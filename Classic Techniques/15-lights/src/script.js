...
const directionalLight = new THREE.DirectionalLight(0xfdb813, 0.3)
...
const spotLight = new THREE.SpotLight(0x78ff00, 0.5, 8, Math.PI * 0.1, 0.15, 1)
...
// gui.add(pointLight, 'decay').min(0).max(20).step(0.001)
